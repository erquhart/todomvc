...
(() => {
    ...
    n = {
      ...
      448: (e, t, n) => {
        ...
        function Kl() {
          if (!Al && null !== Dl) {
            ...
            try {
              ...
              throw (null !== Dl && (Dl = Dl.slice(e + 1)), Cl(Ol, ql), t);
            } finally {
              Al = !1;
            }
          }
            ...
            if (t) {
              ...
              if (!Va(e, t)) {
                if (!(t = qr(n.nextSibling)) || !Va(e, t))
                  return (
                    (e.flags = (-1025 & e.flags) | 2), (Aa = !1), void (Da = e)
                  );
                Ba(Da, n);
              }
              (Da = e), (Ua = qr(t.firstChild));
            } else (e.flags = (-1025 & e.flags) | 2), (Aa = !1), (Da = e);
          }
        }
        function Wa(e) {
          for (
        ...
        function hu(e, t, n) {
          ...
          Vt(e, t, n), e === Ri && ((Vi |= t), 4 === Di && yu(e, ji));
          var r = $l();
          1 === t
            ? 0 != (8 & zi) && 0 == (48 & zi)
              ? bu(e)
        ...
        function vu(e, t) {
          ...
          if (((r = Ft(e, e === Ri ? ji : 0)), (t = jt), 0 === r))
            ...
            15 === t
              ? ((n = bu.bind(null, e)),
                null === Dl ? ((Dl = [n]), (Ul = Cl(Ol, Kl))) : Dl.push(n),
                (n = Il))
              : 14 === t
        ...
        function gu(e) {
          ...
          if (
            ...
            if (
              ...
              throw ((t = Ui), xu(e, 0), yu(e, n), vu(e, Vl()), t);
            switch (
        ...
        function bu(e) {
          ...
          if (
            ...
            throw ((n = Ui), xu(e, 0), yu(e, t), vu(e, Vl()), n);
          return (
  ...
  (l.n = (e) => {
    ...
    (() => {
      ...
      function h(t, n, r, l) {
        void 0 === l && (l = {});
        let { window: a = document.defaultView, v5Compat: s = !1 } = l,
          p = a.history,
          h = e.Pop,
          m = null,
          v = g();
      ...
      function v(e, t, n) {
        ...
        let a = null;
        for (let e = 0; null == a && e < l.length; ++e) a = P(l[e], L(r));
        return a;
      }
      function g(e, t, n, r) {
        void 0 === t && (t = []),
      ...
      function _(e, t) {
        ...
        return (
          ...
          n
            .filter((e) => !C(e))
            .reduce((e, t) => e + (b.test(t) ? w : "" === t ? E : S), r)
        );
      }
      function P(e, t) {
        let { routesMeta: n } = e,
        ...
        for (let e = 0; e < n.length; ++e) {
          ...
          a.push({
            params: r,
            pathname: z([l, s.pathname]),
            pathnameBase: R(z([l, s.pathnameBase])),
            route: c,
          }),
            "/" !== s.pathnameBase && (l = z([l, s.pathnameBase]));
        }
        return a;
      }
      function N(e, t) {
      ...
      const D =
        ...
        { useState: U, useEffect: A, useLayoutEffect: B, useDebugValue: V } = a;
      function $(e) {
      ...
      const q = r.createContext(null);
      const K = r.createContext({ outlet: null, matches: [] });
      ...
      function J() {
        let e = (function () {
            ...
            let t = r.useContext(Y),
              n = le(re.UseRouteError),
              l = ae(re.UseRouteError);
            if (t) return t;
            return null == (e = n.errors) ? void 0 : e[l];
          })(),
          t = M(e)
      ...
      function ee(e) {
        ...
        return (
          ...
          r.createElement(K.Provider, { value: t }, l)
        );
      }
      function te(e, t, n) {
        ...
        return l.reduceRight((e, o, i) => {
          let u = o.route.id ? (null == a ? void 0 : a[o.route.id]) : null,
            s = n ? o.route.errorElement || r.createElement(J, null) : null,
            c = t.concat(l.slice(0, i + 1)),
            f = () =>
              r.createElement(
                ee,
        ...
        return (
          r.Children.forEach(e, (e, l) => {
            ...
            if (e.type === r.Fragment)
              return void n.push.apply(n, ce(e.props.children, t));
            ...
            e.props.children && (o.children = ce(e.props.children, a)),
              n.push(o);
          }),
          n
        );
      ...
      var ve = "ADD_ITEM",
        ...
        be = "TOGGLE_ITEM",
        we = "TOGGLE_ALL",
        ke = "REMOVE_COMPLETED_ITEMS";
      function Ee(e) {
        var n = e.dispatch,
          l = (0, r.useCallback)(
            function (e) {
              return n({ type: ve, payload: { title: e } });
            },
            [n],
          );
      ...
      var Se = l(184),
        ...
        Ce = (0, r.memo)(function (e) {
          var n = e.todo,
            ...
            f = (0, r.useCallback)(
              function () {
                return l({ type: be, payload: { id: c } });
              },
              [l],
            ),
            d = (0, r.useCallback)(
              function () {
                return l({ type: ye, payload: { id: c } });
              },
              [l],
            ),
            p = (0, r.useCallback)(
              function (e, t) {
                return l({ type: ge, payload: { id: e, title: t } });
              },
              [l],
            ),
            ...
            v = (0, r.useCallback)(
              function (e) {
                0 === e.length ? d(c) : p(c, e), i(!1);
              },
              [c, d, p],
            );
          return (0, t.jsx)("li", {
            className: xe()({ completed: n.completed }),
      ...
      function _e(e) {
        var n = e.todos,
          ...
          i = (0, r.useCallback)(
            function (e) {
              return l({ type: we, payload: { completed: e.target.checked } });
            },
            [l],
          );
        return (0, t.jsxs)("main", {
          ...
          children: [
            o.length > 0
              ...
              : null,
            (0, t.jsx)("ul", {
              className: xe()("todo-list"),
              "data-testid": "todo-list",
              children: o.map(function (e, n) {
                return (0, t.jsx)(Ce, { todo: e, dispatch: l, index: n }, e.id);
              }),
            }),
          ],
        });
          ...
          : (0, t.jsxs)("footer", {
              ...
              children: [
                (0, t.jsx)("span", {
                  ...
                  children: ""
                    .concat(o.length, " ")
                    .concat(1 === o.length ? "item" : "items", " left!"),
                }),
                (0, t.jsxs)("ul", {
                  className: "filters",
                  ...
                  children: [
                    ...
                    (0, t.jsx)("li", {
                      children: (0, t.jsx)("a", {
                        className: xe()({ selected: "/active" === a }),
                        href: "#/active",
                        children: "Active",
                      }),
                    }),
                    (0, t.jsx)("li", {
                      children: (0, t.jsx)("a", {
                        className: xe()({ selected: "/completed" === a }),
                        href: "#/completed",
                        children: "Completed",
                      }),
                    }),
      ...
      var Te = function (e, t) {
        switch (t.type) {
          ...
          case we:
            return e.map(function (e) {
              return e.completed !== t.payload.completed
                ? Ne(Ne({}, e), { completed: t.payload.completed })
                : e;
            });
          case ke:
            return e.filter(function (e) {
        ...
        throw Error("Unknown action: ".concat(t.type));
      };
      (0, n.render)(
        (0, t.jsx)(
          function (e) {
            ...
            let i = a.current,
              [u, c] = r.useState({ action: i.action, location: i.location });
            return (
              r.useLayoutEffect(() => i.listen(c), [i]),
              r.createElement(ie, {
                basename: t,
                children: n,
                location: u.location,
          ...
          },
          {
            children: (0, t.jsx)(ue, {
              children: (0, t.jsx)(oe, {
                path: "*",
                element: (0, t.jsx)(function () {
                  var e = (0, r.useReducer)(Te, []),
                    n = e[0],
                    l = e[1];
                  return (0, t.jsxs)(t.Fragment, {
                    children: [
                      (0, t.jsx)(Ee, { dispatch: l }),
                      (0, t.jsx)(_e, { todos: n, dispatch: l }),
                      (0, t.jsx)(Pe, { todos: n, dispatch: l }),
                    ],
                  });
                }, {}),
              }),
